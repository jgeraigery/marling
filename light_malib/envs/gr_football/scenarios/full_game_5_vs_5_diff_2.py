...
def build_scenario(builder):
  ...
  builder.SetBallPosition(x_offset - 0.2, 0.0)
  ...
  builder.AddPlayer(-1.000000, 0.000000, e_PlayerRole_GK, True, False)
  builder.AddPlayer(-0.500000 + x_offset, -0.06356, e_PlayerRole_CB)
  builder.AddPlayer(-0.500000 + x_offset, 0.063559, e_PlayerRole_CB)
