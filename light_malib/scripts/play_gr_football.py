...
# Set the logger.disabled to false to enable the logger
...
parser.add_argument(
    "--config", type=str, default="expr_configs/cooperative_MARL_benchmark/academy/3_vs_1_with_keeper/mappo.yaml"
)
parser.add_argument(
    "--model_0",
    type=str,
    default="light_malib/trained_models/gr_football/academy/best",
)
parser.add_argument(
    "--model_1",
    type=str,
...
print(f'total_run = {args.total_run}')
