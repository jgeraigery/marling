> **Note**: This README is from the original [Light-MALib / GRF_MARL](https://github.com/jidiai/GRF_MARL) repository by [YanSong97](https://github.com/YanSong97) and [DiligentPanda](https://github.com/DiligentPanda), which this project is forked from. It is preserved here for reference. For documentation specific to the MARLING project (TiZero with RND/SSIR exploration), please see the main [README.md](README.md).
